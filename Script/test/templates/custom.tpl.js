    ...
    return `
      <div class="tpl-form-section">
        ...
        <div class="tpl-form-grid single">
          <div class="tpl-field">
            <label class="tpl-label">HTML de la popup</label>
            <textarea class="tpl-textarea" data-field="html" rows="12" 
                      style="font-family: 'Fira Code', 'Consolas', monospace; font-size: 12px; line-height: 1.5;"
                      placeholder="<div>...</div>">${helpers.escapeHtml(data.html || "")}</textarea>
      ...
      <div class="tpl-form-section">
        ...
        <div class="tpl-form-grid single">
          <div class="tpl-field">
            <label class="tpl-label">Styles CSS</label>
            <textarea class="tpl-textarea" data-field="css" rows="12" 
                      style="font-family: 'Fira Code', 'Consolas', monospace; font-size: 12px; line-height: 1.5;"
                      placeholder=".custom-popup { ... }">${helpers.escapeHtml(data.css || "")}</textarea>
          </div>
        </div>
      </div>
    `;
